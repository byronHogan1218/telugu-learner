...
const multipleChoiceQuestionData: QuestionData[] = [
  {
    ...
    hint: ['Plural in english- why are you late all the time', 'Singular in english- what are you doing today?'],
  },
  {
    questionType: QuestionType.multipleChoice,
    questionData: {
      question: 'What does "Evala" (e wa la) mean in English? Use: Evala plans enti',
      choices: [
        {
          id: 0,
          text: 'today',
    ...
    hint: ['Use in english- Plans for today?'],
  },
  {
    questionType: QuestionType.multipleChoice,
    questionData: {
      question: 'What does "Enti" (n tee) mean in English? Use: Evala plans enti',
      choices: [
        {
          id: 0,
          text: 'what',
    ...
    hint: ['Use in english- What are plans for today?'],
  },
  {
    questionType: QuestionType.multipleChoice,
    questionData: {
      question: 'What does "Repu" (ray poo) mean in English? Use: Repu ekkadiki velthunam',
      choices: [
        {
          id: 0,
          text: 'tomorrow',
    ...
    hint: ['Use in english- Where are we going tomorrow?'],
  },
  {
    questionType: QuestionType.multipleChoice,
    questionData: {
...
const fillInTheBlankQuestionData: QuestionData[] = []
